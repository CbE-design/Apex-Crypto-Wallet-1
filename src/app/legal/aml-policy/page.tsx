...
const jsonLd = {
  ...
  name: 'AML, FICA & Compliance Policy — Apex Wallet',
  description: 'Anti-Money Laundering, FICA compliance, and KYC policy for Apex Wallet.',
  ...
  publisher: {
    ...
    contactPoint: {
      '@type': 'ContactPoint',
      email: 'compliance@apexwallet.co.za',
      contactType: 'compliance',
    },
  },
  about: ['AML Policy', 'FICA', 'Anti-Money Laundering', 'KYC', 'FATF', 'South Africa', 'Cryptocurrency'],
};
    ...
    <>
      ...
      <article className="space-y-8">
        ...
        <Section title="10. Compliance Contacts">
          ...
          <address className="not-italic p-4 rounded-xl bg-muted/20 border border-border/40 space-y-1 font-mono text-xs mt-3">
            <p><strong className="text-foreground">Chief Compliance Officer</strong></p>
            <p>Email: <a href="mailto:compliance@apexwallet.co.za">compliance@apexwallet.co.za</a></p>
