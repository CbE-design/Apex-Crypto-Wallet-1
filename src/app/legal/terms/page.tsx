...
const jsonLd = {
  ...
  name: 'Terms of Service — Apex Wallet',
  description: 'Terms and conditions governing your use of Apex Wallet.',
      ...
      <article className="space-y-8">
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-xl bg-amber-500/10 border border-amber-500/20 text-sm text-amber-200/80">
            <strong className="text-amber-300">Important Notice:</strong> Apex Wallet is a non-custodial software application — a tool you use to manage your own crypto keys. It is not a bank, exchange, broker, or financial services provider. Please read these Terms carefully. By using the app, you agree to them. If you do not agree, you must not use the app.
          </div>
        </div>

        <Section title="1. Parties and Acceptance">
          <p>These Terms of Service ("Terms") form an agreement between you ("User", "you", "your") and the provider of <strong className="text-foreground">Apex Wallet</strong> ("Apex", "we", "us", "our"), the publisher of the Apex Wallet software application.</p>
          <p>By downloading, accessing, or using any part of the Apex Wallet application or web interface ("the App"), you confirm that:</p>
        ...
        <Section title="2. Description of the Software">
          <p>Apex Wallet is a <strong className="text-foreground">non-custodial software application</strong>. It is a self-hosted tool that runs on your device and lets you:</p>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <p className="mt-2"><strong className="text-foreground">Non-Custodial Nature:</strong> Apex Wallet never holds, controls, or has access to your funds or private keys. We do not operate as a bank, exchange, broker, money services business, or financial institution, and we do not take custody of any user assets. You are solely responsible for the security of your seed phrase, private key, and PIN. If you lose them, your assets are permanently and irrecoverably lost — we cannot restore access under any circumstances.</p>
        </Section>
        ...
        <Section title="3. Eligibility">
          ...
          <p>Because Apex Wallet is non-custodial software, we do not open financial accounts for you, do not require identity verification, and do not screen, approve, or vet users. You alone control your wallet.</p>
        </Section>
        ...
        <Section title="4. Your Responsibilities">
          ...
          <p>Apex Wallet does not monitor, approve, or intermediate your transactions. The software simply helps you sign and broadcast transactions you initiate yourself.</p>
        </Section>
        ...
        <Section title="5. Acceptable Use">
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Infringing the intellectual property or other rights of Apex Wallet or third parties;</li>
            <li>Introducing malware or interfering with other users' use of the software.</li>
          </ul>
        </Section>

        <Section title="6. Transactions">
          <p>All crypto transactions are initiated, signed, and broadcast by you. Because Apex Wallet is non-custodial:</p>
          <ul className="list-disc pl-5 space-y-1">
        ...
        <Section title="7. Fees">
          <p>Apex Wallet is provided as free-to-use software. The only unavoidable cost of transacting is the <strong className="text-foreground">network (gas) fee</strong> charged by the underlying blockchain, which is paid directly to the network — not to us — and is displayed before you confirm a transaction.</p>
        ...
        <Section title="14. Contact Information">
          ...
          <address className="not-italic mt-3 p-4 rounded-xl bg-muted/20 border border-border/40 space-y-1 font-mono text-xs">
            <p><strong className="text-foreground">Apex Wallet</strong></p>
