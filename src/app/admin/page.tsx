            ...
            <Card>
             ...
             <Card>
                ...
                <CardContent className="space-y-4">
                    <Link href="/admin/notification-center" legacyBehavior passHref>
                        <Button as="a" className="w-full justify-between" variant="outline">
                    ...
                    <Link href="/admin/direct-send" legacyBehavior passHref>
                        <Button as="a" className="w-full justify-between" variant="outline">
                            <div className="flex items-center gap-2">
                                <DollarSign />
                                Direct Send
