...
import { Bell, LogOut, Settings, User, ChevronDown, Copy, ExternalLink } from 'lucide-react';
...
export function Header() {
  ...
  // Generate initials for avatar from email
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <span className="hidden sm:inline text-muted-foreground">{currency.flag}</span>
